...
# phi <- modTS$summary.hy[3,"mean"]#0.98
# plot(modTS$marginals.hyper[[3]],
#      xlab = expression(phi),
#      ylab = "Density", type = 'l')
# abline(v = phi, col = 2)
...
```{r pearson1, echo = FALSE, warning = FALSE, fig.cap= "Check Pearson residuals."}
# data %>%
#   mutate(mu = mod$summary.fitted.values$mean,
#          sigma2 = mu / (1-mu),
#          Pearson_iid = (Resistent - mu) / sqrt(sigma2)
# )
